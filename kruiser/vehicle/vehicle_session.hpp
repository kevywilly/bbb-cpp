#ifndef CAMERA_SESSION_HPP_
#define CAMERA_SESSION_HPP_
...
{
public:
  CameraSession(boost::asio::io_service& io_service, Camera * c)
    : socket_(io_service)
  {
      camera = c;
  }
  ...
  virtual void start()
  {
    socket_.async_read_some(boost::asio::buffer(data_, max_length),
        boost::bind(&CameraSession::handle_read, this,
      ...
      size_t bytes_transferred)
  {
    if (!error)
    {
      boost::asio::async_write(socket_,
          ...
          boost::bind(&CameraSession::handle_write, this,
            boost::asio::placeholders::error));
    }
    else
    {
